                            ...
                            <div id="text-2" class="widget widget_text">
                                ...
                                <address>
                                    ...
                                    <div class="info">
                                        ...
                                        <span><a href="tel:012-345-6789">+91 9130741056</a></span>
                                    </div>
                                </address>
                            </div>
                        </div>
                            ...
                            <div id="nav_menu-2" class="widget widget_nav_menu">
                                ...
                                <div class="menu-quick-links-container">
                                    <ul id="menu-quick-links" class="menu">
                                        <li><a href="books_media">Books Category</a></li>
                                        <li><a href="index">Search</a></li>
                                        <li><a href="index">Meet Our Staff</a></li>
                        ...
                        <div class="col-md-4 col-sm-6 widget-container">
                            <div class="widget twitter-widget">
                                ...
                                <div >
                                    <ul>
                                        <li>
                                            <p><a href="Books">New Books</a> 
                                        </li>
                                        <li>
                                            <p><a href="Magazine">New Magazines</a> 
                                        </li>
                                        <li>
                                            <p><a href="Audio">New Audios</a> 
                                        </li>
                                        <li>
                                            <p><a href="Video">New Videos</a> 
                                        </li>
                                    </ul>
                                </div>
                            </div>          
