                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                <a href="tel:+61-3-8376-6284"><i class="fa fa-phone"></i>e_library phone</a>
                                                <span>/</span>
                                                <a href="mailto:support@librari.com"><i class="fa fa-envelope"></i>support@libraria.com</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                ...
                                                <span>|</span>
                                                <a href="download"><img src="images/download.png" 
                                                    alt="DOWNLOAD" />
                                                </a>
                                    ...
                                    <ul class="nav navbar-nav">
                                        <li class="dropdown active">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="index-2.html">Books</a></li>
                                                <li><a href="home-v2.html">Magazine</a></li>
                                                <li><a href="home-v3.html">Audio</a></li>
                                                <li><a href="home-v3.html">video</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="/signin">Signin/Register</a></li>
                                        ...
                                        <li><a href="layouts/services.html">Services</a></li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="cart.html">Cart</a></li>
                                            <li><a href="checkout.html">Checkout</a></li>
                                            <li><a href="sign_in">Signin/Register</a></li>
                                            <li><a href="404.html">404/Error</a></li>
                                        </ul>
                                    </li>
                                    <li>
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <div class="slide-buttons hidden-sm hidden-xs">    
                                <a href="signin.html" class="btn btn-primary">Become a user</a>
                                <a href="download.html" class="btn btn-default">download our Books</a>
                            </div>
                        </div>
                    </div>
                </div>
