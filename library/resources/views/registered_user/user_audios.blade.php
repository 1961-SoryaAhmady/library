                            ...
                            <div class="col-md-9">
                                ...
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="Books_Media">Books &amp; Media</a>
                                        ...
                                        <li class="dropdown">
                                                <a data-toggle="dropdown" class="dropdown-toggle disabled" href="download">
                                                    DOWNLOAD</a>
                                                <ul class="dropdown-menu">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">You Can Find E Audio here in pdf format</p>
                </div>
                                    ...
                                    <article>
                                        <div class="grid-item blog-item">
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="blog" src="images/blog/blog-02.jpg" />
                                                
                                            </div>
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                   
                                                    <h3 class="entry-title">Here you can upload any Audio</h3>
                            
                                                </header>
                        
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="a_uploadpage">Upload a Audio</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                    <article>
                                        <div class="grid-item blog-item">
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="blog" src="images/blog/blog-03.jpg" />
                                               
                                            </div>
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                   
                                                    <h3 class="entry-title">Here you can download any Audio</h3>
                            
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="a_view">Download A Audio</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                    <article>
                                        <div class="grid-item blog-item">
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="blog" src="images/blog/blog-05.jpg" />
                                              
                                            </div>
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                   
                                                    <h3 class="entry-title">Here you can view any Audio</h3>
                                                    
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="a_view">View a Audio</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                        ...
                        <div class="col-md-4 col-sm-6 widget-container">
                            <div class="widget twitter-widget">
                                ...
                                <div >
                                    <ul>
                                        <li>
                                            <p><a href="Books">Books</a> 
                                        </li>
                                        <li>
                                            <p><a href="Magazine">Magazines</a> 
                                        </li>
                                        <li>
                                            <p><a href="Audio">Audios</a> 
                                        </li>
                                        <li>
                                            <p><a href="Video">Videos</a> 
                                        </li>
                                    </ul>
                                </div>
                            </div>          
