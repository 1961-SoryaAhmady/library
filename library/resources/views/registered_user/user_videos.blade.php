        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">You Can Find E Video here in pdf format</p>
                </div>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can upload any Video</h3>
                            
                                                </header>
                        
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="v_uploadpage">Upload a Video</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can download any Video</h3>
                            
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="v_view">Download A Video</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can view any Video</h3>
                                                    
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="v_view">View a Video</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
