        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">You Can Find Ebooks here in pdf format</p>
                </div>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can upload any book</h3>
                            
                                                </header>
                        
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="uploadpage">Upload a Book</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can download any book</h3>
                            
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="view">Download A Book</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can view any book</h3>
                                                    
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="view">View a Book</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
