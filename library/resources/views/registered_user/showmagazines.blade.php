        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">You Can Find Magazines here in pdf format</p>
                </div>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">User uploaded magazines are here</h3>
                                                </header>
  ...
  <table border="2">
                                                           <th>Name of Magazine </th>
                                                            ...
                                                            <td>{{$data->file}}</td>
                                                                ...
                                                                <td><a href="{{url('/magazine_view',$data->id)}}">View</a>
                                                                </td>
                                                                </tr>
                                                            @endforeach
                                                            </table>
