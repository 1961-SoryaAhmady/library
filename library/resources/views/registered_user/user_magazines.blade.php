                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can upload any magazine</h3>
                            
                                                </header>
                        
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="m_uploadpage">Upload a magazine</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can download any magazine</h3>
                            
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="m_view">Download A Magazine</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="grid-item blog-item">
                                            ...
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    ...
                                                    <h3 class="entry-title">Here you can view any magazine</h3>
                                                    
                                                </header>
                                                
                                                <footer class="entry-footer">
                                                    <a class="btn btn-default" href="m_view">View a magazine</a>
                                                </footer>
                                            </div>
                                        </div>
                                    </article>
